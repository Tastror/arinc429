...
void CARNIC429Dlg::OnChangeEDITRealSpeed() 
{
    // TODO: If this is a RICHEDIT control, the control will not
    // send this notification unless you override the CDialog::OnInitDialog()
    // function and call CRichEditCtrl().SetEventMask()
...
void CARNIC429Dlg::OnKillfocusEDITRealSpeed() 
{
    // TODO: Add your control notification handler code here
    if (this->textbot_send_Azimuth.LineLength(-1)==0)
    {
        ...
        else // untriggered//不需要过滤 .
        {
            if ((ReadFIFOStatus_R(hCard, chno) != FIFOEmpty) && (ReadFIFOStatus_R(hCard, chno) != FIFOError))//读取状态当recieveFIFO 不空且不溢出时
            {
                ...
                case 0x88:    //真空速
                    ...
                    data_difference_RealSpeed.Format("%08x", d); break;
                    //0000 0110 1000 1000
                case 0x86://指示空速
                    s = (short)(d >> 16);
                    data_receive_Speed = s * (2048. / 32768);
                    data_difference_Speed.Format("%08x", d); break;
                    //0000 0110 1000 0110
                case 0x85://马赫数
                    s = (short)(d >> 16);
                    data_receive_Mach = s * (4.096 / 32768);
                    data_difference_Mach.Format("%08x", d); break;
                    //    0000 0110 0001 0101
                case 0x97://装订气压
                    s = (short)(d >> 16);
                    data_receive_AirP = s * (128. / 32768);
                    data_difference_AirP.Format("%08x", d); break;
                    //0000 0110 1001 0111
                case 0xA1://攻角
                    s = (short)(d >> 16);
                    data_receive_Attack = s * (45. / 32768);
                    data_difference_Attack.Format("%08x", d); break;
                    //0000 0110 1010 0001
                case 0x84://相对气压高度
                    s = (short)(d >> 16);
                    data_receive_High = s;
                    data_difference_High.Format("%08x", d); break;
                    //0000 0110 1000 0100
                case 0x8A://升降速度
                    s = (short)(d >> 16);
                    data_receive_SpeedUD = s * (512. / 32768);
                    data_difference_SpeedUD.Format("%08x", d); break;
                    //0000 0110 1000 1010
                case 0x32://航向角
                    s = (short)(d >> 16);
                    data_receive_Azimuth = s * (360. / 32768);
                    data_difference_Azimuth.Format("%08x", d); break;
                    //0000 0110 0011 0010
                case 0x33://俯仰角
                    s = (short)(d >> 16);
                    data_receive_Pitch = s * (180. / 32768);
                    data_difference_Pitch.Format("%08x", d); break;
                    //0000 0110 0011 0011
                case 0x34://横滚角
                    s = (short)(d >> 16);
                    data_receive_Roll = s * (180. / 32768);
                    data_difference_Roll.Format("%08x", d); break;
                    //0000 0110 0011 0100
                case 0x35://无线电高度
                    s = (short)(d >> 16);
                    data_receive_HighR = s * (1524. / 32768);
                    data_difference_HighR.Format("%08x", d); break;
                    //0000 0110 0011 0101
                case 0x36://最低安全高度
                    s = (short)(d >> 16);
                    data_receive_HighL = s * (1500. / 32768);
                    data_difference_HighL.Format("%08x", d); break;
                    //0000 0110 0011 0110 
                case 0x37://侧滑角
                    s = (short)(d >> 16);
                    data_receive_Sideslip = s * (10. / 32768);
                    data_difference_Sideslip.Format("%08x", d); break;
                    //0000 0110 0011 0111
                case 0x38://法向过载
                    s = (short)(d >> 16);
                    data_receive_NormalOverload = s * (10. / 32768);
                    data_difference_NormalOverload.Format("%08x", d); break;
                    //0000 0110 0011 1000
                default:
                    break;
                }
